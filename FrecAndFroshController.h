...
public:
	...
	void drawAllThrowFrecsOnGrid(sf::RenderWindow &theWindow);
	//Throw Objects
	void addThrowObjectToList(int index, sf::Vector2f frecPosition, shared_ptr<Frosh> froshPtr);
	...
	//used for testing
	void addFroshObjectToList(sf::Vector2f _position, sf::Vector2f _size, sf::Texture* _texture,
		int type, double modifier);
	void drawAllFrosh(sf::RenderWindow &theWindow);
